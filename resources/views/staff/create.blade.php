  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body px-3 px-md-4">
        <h5 class="card-title fw-semibold mb-3">Create Staff</h5>
          ...
          <div class="card-body px-3 px-md-4">
            <form action="{{ route('staff.create') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <br>
                <img src="{{ asset('assets/images/profile/profile-not-found.jpg') }}" alt="Profile Staff" class="img-fluid img-preview" width="100">
              ...
              <div class="mb-3">
                  ...
                  <input required name="position" type="text" class="form-control @error('position') is-invalid @enderror" id="position">
                  @error('position')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="wrapper d-flex gap-2">
                ...
                <a href="{{ route('staff') }}" class="btn btn-dark">Cancel Add</a>
              </div>
            </form>
          </div>
        </div>
